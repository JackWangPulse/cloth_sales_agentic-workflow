...
#!/usr/bin/env python3
"""绠€鍗曠殑鏈湴 HTTP 鏈嶅姟鍣紝鐢ㄤ簬杩愯 demo_vision_similar.html

浣跨敤鏂规硶锛?
    python scripts/start_vision_demo_server.py
...
def main():
    ...
    with socketserver.TCPServer(("", PORT), MyHTTPRequestHandler) as httpd:
        ...
        print("=" * 60)
        print("馃殌 Vision Demo 鏈嶅姟鍣ㄥ凡鍚姩锛?)
        print("=" * 60)
        print(f"馃摫 璁块棶鍦板潃: {url}")
