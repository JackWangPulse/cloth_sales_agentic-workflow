...
def main():
    ...
    # Initial full build should write the legacy single-index format.
    # Incremental mode is for later updates and expects base/delta indexes.
    vector_store = VectorStore(use_incremental=False)
