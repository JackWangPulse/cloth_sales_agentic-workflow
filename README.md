...
# 测试意图分析
python manual_tests/test_intent_engine.py

# 测试跟进建议
python manual_tests/test_followup_service.py

# 测试 Agent 系统
python manual_tests/test_agent_framework.py
python manual_tests/test_agent_tools.py
python manual_tests/test_planner_agent.py
python manual_tests/test_worker_agents.py
python manual_tests/test_sales_graph.py
```
